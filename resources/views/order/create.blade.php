        ...
        @csrf
            <div class="row">                    
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" name="number_orden" class="form-control" placeholder="Ingrese El numero de orden" value="{{ old('number_orden') }}">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="fecha">FECHA</label>
                        <input type="date" name="fecha" class="form-control" value="{{ old('feche') }}">
                    </div>
            </div>
            <div class="row">
                    <div class="form-group col-md-6">
                        <label for="monto">MONTO</label>
                        <input type="number" step="any" name="monto" class="form-control" required placeholder="Ingrese El precio"value="{{ old('monto') }}">
                    </div>
                    <div class="form-group col-md-6">
                        <label>Estado</label>
            ...
            <div class="row">
                    <div class="form-group col-md-6">
                        <label  class="control-label" for="id_detalle">DETALLE</label>
                         {{  Form::select('id_detalle', $orders_details,null,['class' => 'form-control','placeholder' => 'Selecciona un detalle para du pedido'])}}
                    </div>
                    <div class="form-group col-md-6">
